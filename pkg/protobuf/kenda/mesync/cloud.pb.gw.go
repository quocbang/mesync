...
func request_Cloud_UploadBlob_0(ctx context.Context, marshaler runtime.Marshaler, client CloudClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterCloudHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CloudServer) error {
	...
	mux.Handle("POST", pattern_Cloud_UploadBlob_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterCloudHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CloudClient) error {
	...
	mux.Handle("POST", pattern_Cloud_UploadBlob_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Cloud_UploadBlob_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Cloud_UploadBlob_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Cloud_UploadBlob_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cloud", "blob-storage"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Cloud_UploadBlob_0 = runtime.ForwardResponseMessage
)
